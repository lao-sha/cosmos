//! # ShareMall 返佣管理模块 (pallet-sharemall-commission)
//!
//! ## 概述
//!
...
pub mod pallet {
    ...
    use pallet_sharemall_common::{MemberLevel, ShopProvider};
    ...
    pub trait Config: frame_system::Config {
        ...
        /// 最大多级分销层数
        #[pallet::constant]
        type MaxMultiLevels: Get<u32> + TypeInfo;

        /// 最大自定义等级数
        #[pallet::constant]
        type MaxCustomLevels: Get<u32> + TypeInfo;
    }
...
pub trait MemberProvider<AccountId> {
    ...
    /// 获取会员等级
    fn member_level(shop_id: u64, account: &AccountId) -> Option<pallet_sharemall_common::MemberLevel>;
...
impl<AccountId> MemberProvider<AccountId> for NullMemberProvider {
    ...
    fn member_level(_shop_id: u64, _account: &AccountId) -> Option<pallet_sharemall_common::MemberLevel> { None }
