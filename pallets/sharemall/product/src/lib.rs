//! # 商城商品管理模块 (pallet-sharemall-product)
//!
//! ## 概述
//!
//! 本模块负责商品的生命周期管理，包括：
...
pub use pallet::*;
pub use pallet_sharemall_common::{ProductCategory, ProductStatus};
...
pub mod pallet {
    ...
    use pallet_sharemall_common::{PricingProvider, ProductCategory, ProductProvider, ProductStatus, ShopProvider};
    use sp_runtime::{
    ...
    /// 商品押金托管 PalletId
    const PRODUCT_PALLET_ID: PalletId = PalletId(*b"sm/prod/");
