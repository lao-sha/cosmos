//! # 商城订单管理模块 (pallet-sharemall-order)
//!
//! ## 概述
//!
//! 本模块负责订单的完整生命周期管理，包括：
...
pub use pallet::*;
pub use pallet_sharemall_common::MallOrderStatus;
...
pub mod pallet {
    ...
    use pallet_sharemall_common::{MallOrderStatus, OrderProvider, ProductCategory, ProductProvider, ShopProvider, ShopTokenProvider};
