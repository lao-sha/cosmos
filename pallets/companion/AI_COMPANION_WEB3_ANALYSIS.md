...
| 成本项 | 频率 | 单次成本 | 年度成本估算 |
|--------|------|---------|-------------|
| **创建 AI 陪伴** | 一次性 | ~0.1 DUST | - |
| **每次对话** | 每天 10 次 | ~0.01 DUST | ~36.5 DUST/年 |
| **IPFS 存储** | 持续 | 免费 | 免费 |
| **NFT 铸造** | 可选 | ~0.05 DUST | - |

**年度成本估算**：
- **轻度用户**（每天 5 次对话）：~18.25 DUST/年
- **中度用户**（每天 10 次对话）：~36.5 DUST/年
- **重度用户**（每天 20 次对话）：~73 DUST/年
...
| **Web3 按次付费** | ~0.01 DUST/次 | $0.001-0.03/次 | 取决于使用频率 |
